function [count,winners] = parStiffnessCheck(dt, n, n_fill, V_f)
% Inputs:
...
%
% Outputs:
%   count   The number of laminate designs that pass the stiffness check
...
% and returns those that pass the stiffness check.
